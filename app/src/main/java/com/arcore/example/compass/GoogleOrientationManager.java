 ...
 */
public class GoogleOrientationManager {
    ...
    public interface OnChangedListener {
         ...
         */
        void onOrientationChanged(GoogleOrientationManager orientationManager);
         ...
         * @param orientationManager the orientation manager that detected the change
         */
        void onLocationChanged(GoogleOrientationManager orientationManager);
         ...
         * @param orientationManager the orientation manager that detected the change
         */
        void onAccuracyChanged(GoogleOrientationManager orientationManager);
    }
    ...
    /**
     * Initializes a new instance of {@code GoogleOrientationManager}, using the specified context to
     * access system services.
     */
    public GoogleOrientationManager(SensorManager sensorManager, LocationManager locationManager) {
